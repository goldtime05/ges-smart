            ...
            $("#employeeAddForm").validate({
                ...
                messages: {
                    ...
                    phone: {
                        ...
                        minlength: "Numbers minimum length should be 7 digits",
        ...
        $(document).on('click','#employee_edit_user',function(){
            ...
            $("#employeeEditUser").validate({
                ...
                messages: {
                    ...
                    mobile: {
                        minlength: 'Mobile number minimum length should be 7 digit',
                        mobilevalidation: 'Mobile Number is invalid'
                    },
                    phone: {
                        required: 'Phone must not empty',
                        minlength: "Phone number minimum length should be 7 digits",
                        isPhoneValid: 'Entered Number is invalid'
                    },
                    department_id: {
                        required:'Please select a department',
...
$(document).on('click','.DeleteDeduction',function(){
    ...
    $('.add_more_revenue').click(function() {
     ...
     var add_div = '<div class="row AlLRevenues"><a class="remove_revenue_div" style="cursor: pointer;"><i class="fa fa-trash-o"></i></a> <div class="col-md-4"><div class="form-group"><label>Revenue Title <span class="text-danger">*</span></label><input type="text" class="form-control RevenuETitle" value="" placeholder="Revenue Title" name="revenue_title[]" autocomplete="off"></div></div><div class="col-md-3"><div class="form-group"><label>Revenue Amount <span class="text-danger">*</span></label><input type="text" name="revenue_amount[]" placeholder="Amount" value="" class="form-control RevenuEAmount" autocomplete="off" ></div></div><div class="col-md-4"><div class="col-sm-6"><label>Quantity <span class="text-danger">*</span></label><input type="" name="revenue_quantity[]" class="form-control"></div><div class="col-sm-6"><label>Created at <span class="text-danger">*</span></label><div class="cal-icon"><input type="text" class="form-control datetimepicker" data-date-format="dd-mm-yyyy" required name="revenue_create_date[]"></div></div></div></div>';
    ...
    $('.AllRevenuesClass').on('click','.remove_revenue_div',function() {
        ...
        var percent_of_total_amt=total_amount/parseInt(overall_revenue)*100;
        $('#percent').val(percent_of_total_amt+'%');
        // alert(total_amount);
    ...
    $('.add_more_expenses').click(function() {
        ...
        var add_div = '<div class="row AlLExpenses"><a class="remove_expenses_div" style="cursor: pointer;"><i class="fa fa-trash-o"></i></a><div class="col-sm-4"><div class="form-group"><label>Expenses Title <span class="text-danger">*</span></label><input type="text" class="form-control EXpensesTItle" value=""  placeholder="Expenses Title" name="expenses_title[]" autocomplete="off"></div></div><div class="col-sm-3"><div class="form-group"><label>Expenses Amount <span class="text-danger">*</span></label><input type="text" name="expenses_amount[]" placeholder="Amount" value="" class="form-control EXpensesAmount" autocomplete="off"></div></div><div class="col-md-4"><div class="col-sm-6"><label>Quantity <span class="text-danger">*</span></label><input type="number" required="" name="expenses_quantity[]" class="form-control"></div><div class="col-sm-6"><label>Created at <span class="text-danger">*</span></label><div class="cal-icon"><input type="text" required="" class="form-control datetimepicker" data-date-format="dd-mm-yyyy" name="expenses_create_date[]"></div></div></div><div class="col-sm-1"></div></div></div>';
    ...
    $('.AllExpensesClass').on('click','.remove_expenses_div',function() {
        ...
        var overall_expenses = $('#overall_expenses').val();
        var total_amount = parseInt(overall_revenue) - parseInt(overall_expenses);
         var percent_of_total_amt=total_amount/parseInt(overall_revenue1)*00;
        $('#percent').val(percent_of_total_amt+'%');
        // alert(total_amount);
        $('#expected_profit').val(total_amount);
...
// ));
 ...
 $('#check_projectname').change(function(){
        var check_projectname = $(this).val();
        $.post(base_url+'projects/check_projectname/',{check_projectname:check_projectname},function(res){
                // alert(res); return false;
                if(res == 1){
                    $('#already_projecttitle').css('display','');
                    $('#project_add_submit').attr('disabled','disabled');
                    return false;
                }else if(res == 0){
                    $('#already_projecttitle').css('display','none');
 ...
 $('#req_leave_type').change(function(){
        var leave_id = $('#req_leave_type option:selected').val();
        // alert(leave_id); return false;
        $.post(base_url+'leaves/check_leaves/',{leave_id:leave_id},function(res){
                 // alert(res); return false;

                 $('#total_leave_counts').val(res);
                 // toastr.success(res);
        });
    });
