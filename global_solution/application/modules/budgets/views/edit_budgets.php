						...
						<form method="post" action="<?php echo base_url(); ?>budgets/edit_budgets/<?php echo $budgets['budget_id']; ?>">
							...
							<div class="AllRevenuesClass">
								...
								<?php 
									...
									$revenue_quantity = json_decode($budgets['revenue_quantity']); 
									$revenue_created_at = json_decode($budgets['revenue_created_at']); 
									$total_amt_rev = json_decode($budgets['total_amt_rev']); 
								...
								<div class="row AlLRevenues">
									...
									<div class="col-md-4">
										<div class="col-sm-6">
											...
											<input type="text" value="<?php echo $revenue_quantity[$i]; ?>" required="" name="revenue_quantity[]" class="form-control revenue_quantity">
											<input type="hidden" name="total_amt[]" class="total_amt" value="<?php echo $total_amt_rev[$i]; ?>">
										</div>
										<div class="col-sm-6">
											<label>Created at <span class="text-danger">*</span></label>
											<div class="cal-icon">
											<input type="text" value="<?php echo $revenue_created_at[$i]; ?>" required="" class="form-control datetimepicker" data-date-format="dd-mm-yyyy" name="revenue_create_date[]"></div>
										</div>
							...
							<div class="AllExpensesClass">
								...
								<?php 
									...
									$expense_quantity = json_decode($budgets['expense_quantity']); 
									$expense_created_at = json_decode($budgets['expense_created_at']); 
									$total_amt_exp = json_decode($budgets['total_amt_exp']); 
								...
								<div class="row AlLExpenses">
									...
									<div class="col-md-4">
										<div class="col-sm-6">
											<label>Quantity <span class="text-danger">*</span></label>
											<input type="text" required="" name="expenses_quantity[]" value="<?php echo $expense_quantity[$i]; ?>" class="form-control exp_qty">
											<input type="hidden" name="total_amt_exp[]" class="total_amt_exp" value="<?php echo $total_amt_exp[$i]; ?>">
										</div>
										<div class="col-sm-6">
											<label>Created at <span class="text-danger">*</span></label>
											<div class="cal-icon">
											<input type="text" required="" class="form-control datetimepicker" value="<?php echo $expense_created_at[$i]; ?>" data-date-format="dd-mm-yyyy" name="expenses_create_date[]"></div>
										</div>
									</div>
							...
							<div class="form-group">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<label>Expected Profit Rate <span class="text-danger">( % )</span> </label>
										<input type="text" class="form-control" name="expected_profit_rate" readonly class="percent" id="percent" value="<?php echo $budgets['expected_profit_rate']; ?>" style="cursor: not-allowed;" placeholder="Expected Profit %" >
									</div>								
								</div>
